...
from wtforms import StringField, IntegerField, PasswordField, DecimalField, SubmitField, ValidationError, Form, FormField, FieldList
...
from ..models import User, Role, Candidate, Question
...
class QuestionForm(FlaskForm):
    question_text = StringField('Enter question text', validators=[DataRequired(), Length(1, 256)])
